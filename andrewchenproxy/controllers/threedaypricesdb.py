...
class threedaypricesdb:
  ...
  def GET(self):
    ...
    result = memcache.get('threedaypricesdb')
    ...
    select_sql="""SELECT destination_airport, there_date, back_date, check_date, price FROM 3dayweekends"""
    ...
    memcache.add('threedaypricesdb', result, 86400) # 24 hours.
